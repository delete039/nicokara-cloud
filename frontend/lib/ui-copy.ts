export const HOME_COPY = {
  introduction:
    "上传原版 MV 和日语歌词：支持的浏览器会把视频保留在浏览器，仅上传音频到服务器。先确认假名注音，再由高精度时间轴引擎生成 Mora 时间轴和字幕。",
  steps: [
    {
      title: "提交素材",
    ...
    {
      title: "确认假名注音",
      text: "服务器整理歌词读音后先暂停，确认或修正每个词的假名，再交给高精度时间轴引擎对齐。",
    },
    {
      title: "对齐与导出",
      text: "高精度时间轴引擎使用确认后的读音生成 Mora 时间轴；主模型异常时会自动切换备用方案，完成后可在浏览器中预览、调整时间并导出。",
    },
  ],
  callToAction: "开始创建",
  author: {
...
export const JOB_COPY = {
  ...
  resultHeading: "生成结果",
  downloadTranscript: "下载原始歌声识别数据",
  downloadLyrics: "下载歌词处理数据",
  downloadTimeline: "下载歌词时间轴",
  downloadAssSubtitle: "下载 ASS 字幕",
  downloadReviewedLyrics: "下载调整后注音数据",
  downloadReviewedTimeline: "下载调整后时间轴",
  downloadReviewedAss: "下载调整后 ASS 字幕",
